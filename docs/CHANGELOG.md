...
- Changed the TR4 hold-to-confirm bars, such as Reset All and Delete, to gold, to match the rest of the TR4 interface (TRX1511)
...
- Fixed missing and incorrect textures in Race for the Iris rooms 4, 27, 31, 99 and 103 (TRX1372 / TRX1463 / TRX1508)
- Fixed the camera being able to enter the space occupied by switch 39 in Race for the Iris (OG bug) (TRX1463)
- Fixed door 84 in Race for the Iris not being triggered by Von Croy (OG bug) (TRX1508)
- Fixed inaccurate bounding boxes on some static meshes in Race for the Iris (OG bug) (TRX1463)
